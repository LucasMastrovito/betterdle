...
function Gacha() {
    ...
    const modes = [
        ...
        <Classic key={'classic'} name={"gacha"} mode="classi" data={data} fields={fields} first_tips={{name: "First Arc", key: "first_arc"}} second_tips={{name: "First Episode", key: "first_episode"}} />,
