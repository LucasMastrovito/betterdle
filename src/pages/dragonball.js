...
function Dragonball() {
    ...
    const modes = [
        ...
        <Classic key={'classic'} name={"dragonball"} mode="classic" desc={"Find the daily character"} fields={fields} first_tips={{ name: "Race", key: "race" }} second_tips={{ name: "First Appearance", key: "first_arc_or_film" }} />,
        <Findmode key={'technique'} name={"dragonball"} mode="technique" desc={"Who is using this technique?"} filter="attack" first_tips={{ name: "Race", key: "race" }} second_tips={{ name: "First Appearance", key: "first_arc_or_film" }} />,
        <Findmode key={'picture'} name={"dragonball"} mode="picture" desc={"Guess from a filtered image"} filter="image_url" />
    ];
