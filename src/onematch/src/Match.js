...
import './App.css';
import dataJson from '../../json/sonic_characters.json';
...
function Match() {
  ...
  const [data, setData] = useState(filterJson(dataJson));
  const [display, setDisplay] = useState(filterJson(dataJson));
        ...
        <div className='container'>
          ...
          {display[i] ?
            <div>
              ...
              {
                display[i].image_url ?
                  <img src={display[i].image_url.includes(".png") ? display[i].image_url.split(".png")[0] + ".png" : display[i].image_url.includes(".jpg") ? display[i].image_url.split(".jpg")[0] + ".jpg" : display[i].image_url.split(".jpeg")[0] + ".jpeg"} alt='img'></img> :
                  <p>Pas d'image</p>
              }
              <div className='btns'>
